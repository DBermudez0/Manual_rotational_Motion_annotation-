...
Then the corresponding slice will appear if you already started annotation some of the slices the code will use the last slice you left off from the excel file created
If you are just starting this volume the code will create a new excel sheet and will start automatically recording the slces that you being annotation
